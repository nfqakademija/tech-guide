...
class Version20180517103120 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE filter_usage ' .
            'ADD html_id INT NOT NULL, CHANGE answer_history_id answer_history_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE filter_usage ' .
            'ADD CONSTRAINT FK_F95AAD8F3CD4754E FOREIGN KEY (html_id) REFERENCES html (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE filter_usage ' .
            'DROP html_id, CHANGE answer_history_id answer_history_id INT NOT NULL');
    }
}
