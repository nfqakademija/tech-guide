...
class Version20180422104116 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE shop_question (question_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_6D4FB3D81E27F6BF (question_id), INDEX IDX_6D4FB3D812469DE2 (category_id), PRIMARY KEY(question_id, category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
